  ...
  return (
    ...
    >
      ...
      {showVoice && character.voices && (
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 bg-white text-gray-800 px-3 py-2 rounded-xl text-xs max-w-[150px] text-center shadow-lg z-50 whitespace-normal">
          {getRandomVoice()}
